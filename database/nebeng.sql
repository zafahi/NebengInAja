...
-- Dibuat untuk mahasiswa CS semester 5
-- =============================================

-- Buat database
CREATE DATABASE IF NOT EXISTS nebeng_db;
USE nebeng_db;
...
-- Status: 'menunggu', 'aktif', 'dalam_perjalanan', 'selesai', 'dibatalkan'
-- =============================================
CREATE TABLE trips (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- Status Booking: 'pending', 'diterima', 'ditolak', 'dibatalkan', 'dalam_perjalanan', 'selesai'
-- Status Pembayaran: 'belum_bayar', 'menunggu_konfirmasi', 'berhasil', 'gagal', 'refund'
-- =============================================
